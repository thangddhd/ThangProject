...
namespace coms.COMSK.ui
{
	...
	public partial class K300030020 : MyForm
	{
		...
		private int currentAccountPeriod = int.MinValue;

        private coms.COMSK.ui.common.CtrLongtermRepairPlan_Total<LongRepairPlanData> ctrLongtermPlan_Total;
        #endregion
		...
		private void InitLongTermPlan_Total()
		{
            // 
            // ctrLongtermPlan_Total
            // 
            this.ctrLongtermPlan_Total = new common.CtrLongtermRepairPlan_Total<LongRepairPlanData>();
            this.ctrLongtermPlan_Total.Dock = DockStyle.Fill;
			this.ctrLongtermPlan_Total.Size = new System.Drawing.Size(1000, 494);
			this.ctrLongtermPlan_Total.Editable = false;
            this.tabPage_Total2.Controls.Add(this.ctrLongtermPlan_Total);
            this.ctrLongtermPlan_Total.DisabledDrawDragRectange();
            this.ctrLongtermPlan_Total.SetParentForm(this);
			this.ctrLongtermPlan_Total.SetRightColumns("bgcolSubTotal");
		...
		private void RefreshCurrentTab(bool tabChanged = false)
		{
			try
			{
				...
				else if (selected == this.tabPage_Total2)
				{
					...
					ctrLongtermPlan_Total.SetRightColumns("bgcolSubTotal");
                }
		...
		private void K200010030_Load(object sender, EventArgs e)
		{
			try
			{
				...
				//  基準年
				{
					...
					// 表示最初期
					this.currentAccountPeriod = LongRepairPlan.AccountPeriod;
		...
		private void btnSetBaseYear_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				{
					if (accountPeriod != this.currentAccountPeriod)
                    {
						this.currentAccountPeriod = accountPeriod;
