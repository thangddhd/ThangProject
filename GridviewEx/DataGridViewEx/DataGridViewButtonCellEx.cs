...
{
    public class DataGridViewButtonCellEx : DataGridViewButtonCell, ISpannedCell
    {
        #region Fields
                                                ...
                                                DataGridViewDataErrorContexts context)
        {
            if (m_OwnerCell != null)
            {
                return m_OwnerCell.GetFormattedValue(value, rowIndex,
                                                                ref cellStyle,
                                                                valueTypeConverter,
                                            ...
                                            System.ComponentModel.TypeConverter valueTypeConverter)
        {
            if (m_OwnerCell != null)
            {
                return m_OwnerCell.ParseFormattedValue(formattedValue, cellStyle,
        ...
        //        RowIndex + RowSpan - 1] as DataGridViewButtonCellEx;
    ...
    public class DataGridViewButtonColumnEx : DataGridViewButtonColumn
    {
        ...
        public DataGridViewButtonColumnEx() : base()
        {
            ...
            this.DefaultCellStyle.Padding = new Padding(2, 2, 2, 2);
            this.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            this.DefaultCellStyle.BackColor = Color.FromArgb(235, 229, 215);
            //this.DefaultCellStyle.Font = new Font("Segoe UI", 9.75f, FontStyle.Bold);
        }
        #endregion
    }
}
